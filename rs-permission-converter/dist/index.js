...
var require_permconv = __commonJS({
  "src/permconv.js"(exports, module2) {
    var os = require("os");
    ...
    var permissionConvCommand = async (converter, args) => {
      const {
        type,
        workDir,
        permFile,
    ...
    var downloadPermConvTool = async (args) => {
    ...
    var convertPermissions2 = async (args) => {
