...
var require_src5 = __commonJS({
  "../utils/src/index.js"(exports2, module2) {
    ...
    var failIfNotTrunkBased2 = require_trunk_killswitch();
    var getImageDigest = require_image_digest();
    module2.exports = {
      checkEnv,
      failIfNotTrunkBased: failIfNotTrunkBased2,
      gitConfig,
      loadTool,
      loadGitHubToken,
      run: run2,
...
var require_setup_gcloud = __commonJS({
  "../setup-gcloud/src/setup-gcloud.js"(exports2, module2) {
    ...
    var setupGcloud2 = async (serviceAccountKey, version = "latest", exportCredentials = false) => {
      let semver = version;
...
// src/project-labels.js
var require_project_labels = __commonJS({
  "src/project-labels.js"(exports2, module2) {
    var exec = require_exec3();
    var projectLabels = async (projectId) => {
      let output = "";
      await exec.exec("gcloud", [
        "projects",
        "describe",
    ...
    module2.exports = projectLabels;
  }
});

// src/deploy-job.js
var require_deploy_job = __commonJS({
  "src/deploy-job.js"(exports2, module2) {
    var exec = require_exec3();
    var projectLabels = require_project_labels();
    var deployJob2 = async (newJobName, parameters, dataflowServiceAccount, templatePath, region, projectId, mode, stagingLocation, network, subnetwork, maxWorkers, numWorkers) => {
      const args = [
        "dataflow",
        mode,
        "run",
    ...
    module2.exports = deployJob2;
  }
});

// src/drain-job.js
var require_drain_job = __commonJS({
  "src/drain-job.js"(exports2, module2) {
    var exec = require_exec3();
    var getJobs = async (region, jobName, newJobId, projectId) => {
      let output = "";
      await exec.exec("gcloud", [
        "dataflow",
        "jobs",
    ...
    var drainJob2 = async (newJobId, jobName, region, projectId) => {
...
var require_cluster_info = __commonJS({
  "../cloud-run/src/cluster-info.js"(exports2, module2) {
    ...
    var getTribeProject2 = async (projectId) => {
    ...
    var getClusterInfo = async (projectId, cluster = "") => {
      ...
      const tribeProject = await getTribeProject2(projectId);
      return getClusterDetails(tribeProject, cluster);
    };
    module2.exports = {
      getClusterInfo,
      getTribeProject: getTribeProject2
    };
  }
});
...
var { run, failIfNotTrunkBased } = require_src5();
var setupGcloud = require_setup_gcloud();
var deployJob = require_deploy_job();
var drainJob = require_drain_job();
var { getTribeProject } = require_cluster_info();
var action = async () => {
