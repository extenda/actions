...
// src/create-sign-attestion.js
var require_create_sign_attestion = __commonJS({
  "src/create-sign-attestion.js"(exports2, module2) {
    var exec = require_exec();
    var createAttestation2 = async (artifactUrl, attestor, attestorProject, keyversionProject, keyversionLocation, keyversionKeyring, keyversionKey, keyversion) => {
      const args = [
        "--quiet",
        "beta",
        "container",
    ...
    var getArtifactUrl2 = async (tag, imagePath) => {
    ...
    module2.exports = {
      createAttestation: createAttestation2,
      getArtifactUrl: getArtifactUrl2
    };
  }
});
...
var { createAttestation, getArtifactUrl } = require_create_sign_attestion();
