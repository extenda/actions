...
// src/dataflow-build.js
var require_dataflow_build = __commonJS({
  "src/dataflow-build.js"(exports2, module2) {
    var exec = require_exec();
    var dataflowBuild2 = async (templatePath, image, sdkLanguage, metadataPath, jarPath, envVars) => {
      const args = [
        "dataflow",
        "flex-template",
        "build",
    ...
    module2.exports = dataflowBuild2;
  }
});
...
var dataflowBuild = require_dataflow_build();
