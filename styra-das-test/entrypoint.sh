...
SYSTEM_ID=$(curl -X GET "https://extendaretail.svc.styra.com/v1/systems?compact=false&name=$STYRA_SYSTEM_NAME" -H "authorization: bearer $STYRA_TOKEN" -H "content-type: application/json" | jq -r '.result[0].id')
