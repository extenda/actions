...
#### <a name="oneOf_i1_kubernetes_scaling"></a>2.1.8. Property `CloudDeploy > oneOf > Kubernetes > kubernetes > scaling`
...
##### <a name="oneOf_i1_kubernetes_volumes_items"></a>2.1.9.1. CloudDeploy > oneOf > Kubernetes > kubernetes > volumes > Volume
