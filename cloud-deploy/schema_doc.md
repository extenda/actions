...
- [2. Property `CloudDeploy > oneOf > Kubernetes`](#oneOf_i1)
  - [2.1. Property `CloudDeploy > oneOf > Kubernetes > kubernetes`](#oneOf_i1_kubernetes)
    ...
    - [2.1.8. Property `CloudDeploy > oneOf > Kubernetes > kubernetes > volumes`](#oneOf_i1_kubernetes_volumes)
      - [2.1.8.1. CloudDeploy > oneOf > Kubernetes > kubernetes > volumes > Volume](#autogenerated_heading_4)
...
##### <a name="autogenerated_heading_4"></a>2.1.8.1. CloudDeploy > oneOf > Kubernetes > kubernetes > volumes > Volume
...
----------------------------------------------------------------------------------------------------------------------------
Generated using [json-schema-for-humans](https://github.com/coveooss/json-schema-for-humans) on 2025-03-28 at 09:13:58 +0100
