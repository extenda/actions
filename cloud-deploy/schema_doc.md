        ...
        - [1.1.12.2.2. Property `CloudDeploy > oneOf > CloudRun > cloud-run > monitoring > open-telemetry > config`](#oneOf_i0_cloud-run_monitoring_open-telemetry_config)
          ...
          - [1.1.12.2.2.2. Property `CloudDeploy > oneOf > CloudRun > cloud-run > monitoring > open-telemetry > config > oneOf > item 1`](#oneOf_i0_cloud-run_monitoring_open-telemetry_config_oneOf_i1)
            ...
            - [1.1.12.2.2.2.5. Property `CloudDeploy > oneOf > CloudRun > cloud-run > monitoring > open-telemetry > config > oneOf > item 1 > collect`](#oneOf_i0_cloud-run_monitoring_open-telemetry_config_oneOf_i1_collect)
              - [1.1.12.2.2.2.5.1. CloudDeploy > oneOf > CloudRun > cloud-run > monitoring > open-telemetry > config > oneOf > item 1 > collect > collect items](#autogenerated_heading_3)
      - [1.1.12.3. Property `CloudDeploy > oneOf > CloudRun > cloud-run > monitoring > preview-tag`](#oneOf_i0_cloud-run_monitoring_preview-tag)
...
- [5. Property `CloudDeploy > environments`](#environments)
  - [5.1. Property `CloudDeploy > environments > production`](#environments_production)
    ...
    - [5.1.3. Property `CloudDeploy > environments > production > domain-mappings`](#environments_production_domain-mappings)
      - [5.1.3.1. CloudDeploy > environments > production > domain-mappings > Domain](#autogenerated_heading_7)
...
##### <a name="autogenerated_heading_3"></a>1.1.12.2.2.2.5.1. CloudDeploy > oneOf > CloudRun > cloud-run > monitoring > open-telemetry > config > oneOf > item 1 > collect > collect items
...
##### <a name="oneOf_i0_cloud-run_monitoring_preview-tag"></a>1.1.12.3. Property `CloudDeploy > oneOf > CloudRun > cloud-run > monitoring > preview-tag`
...
----------------------------------------------------------------------------------------------------------------------------
Generated using [json-schema-for-humans](https://github.com/coveooss/json-schema-for-humans) on 2025-06-05 at 09:32:33 +0200
