...
const createCertificate = async (projectID, region = 'europe-west1') =>
  gcloudOutput([
    'compute',
    'ssl-certificates',
    'create',
...
const createHttpProxy = async (projectID, env) =>
  gcloudOutput([
    'compute',
    'target-http-proxies',
    'create',
...
const createHttpsProxy = async (projectID, env) =>
  gcloudOutput([
    'compute',
...
const createForwardingRule = async (projectID) =>
  gcloudOutput([
    'compute',
    'forwarding-rules',
    'create',
...
const createHttpsForwardingRule = async (projectID) =>
  gcloudOutput([
    'compute',
    'forwarding-rules',
    'create',
...
const configureInternalFrontend = async (
  projectID,
  name,
  env,
  protocol,
