...
const SHA_VALUE = 'sha256:043112bde49f2244cf9e4c44d059603a7c056d13ad61ef3492f04374ac9a0396';
...
test('It resolves SHA256 tag from semver image', async () => {
  const sha256Image = await getImageWithSha256('eu.gcr.io/extenda/actions-test:v1.0.0');
...
test('It can handle image without semver tag', async () => {
  const sha256Image = await getImageWithSha256('eu.gcr.io/extenda/actions-test');
  expect(sha256Image).toEqual(`eu.gcr.io/extenda/actions-test@${SHA_VALUE}`);
  expect(execGcloud).toHaveBeenCalledWith([
    'container',
    'images',
