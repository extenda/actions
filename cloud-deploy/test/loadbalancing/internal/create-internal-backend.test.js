...
describe('configureInternalDomain', () => {
  ...
  test('should setup internal domain with correct parameters', async () => {
    ...
    expect(gcloudOutput).toHaveBeenNthCalledWith(7, [
      'compute',
      'backend-services',
      'add-backend',
      `${name}-internal-backend`,
    ...
    expect(gcloudOutput).toHaveBeenNthCalledWith(8, [
      'compute',
      'backend-services',
      'add-backend',
      `${name}-internal-backend`,
    ...
    expect(gcloudOutput).toHaveBeenNthCalledWith(9, [
      'compute',
      'backend-services',
      'add-backend',
      `${name}-internal-backend`,
    ...
    expect(createInternalLoadbalancer).toHaveBeenCalledWith(
      projectID,
      env,
      name,
    );

    expect(gcloudOutput).toHaveBeenNthCalledWith(10, [
      'compute',
      'url-maps',
      'add-path-matcher',
  ...
  test('should setup internal domain with correct parameters if cloudrun', async () => {
    ...
    expect(gcloudOutput).toHaveBeenNthCalledWith(6, [
      'compute',
      'url-maps',
      'add-path-matcher',
      `${projectID.split(`-${env}`)[0]}-${env}-lb-internal`,
