...
describe('handle errors', () => {
  ...
  test('It can identify permission error and throw error', async () => {
    const errorMessage = { message:`ERROR: (gcloud.compute.network-endpoint-groups.create) Could not fetch resource:
  ...
  test('It can identify was not found error and continue', async () => {
    const errorMessage = { message:`ERROR: (gcloud.compute.url-maps.create) Could not fetch resource:
